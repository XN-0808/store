		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium"
						 src="${pageContext.request.contextPath}/${singleProduct.pimage}">
					</div>

					<div class="col-md-6">
						<div><strong>${singleProduct.pname}</strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>${singleProduct.pid}</div>
						</div>

						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${singleProduct.shop_price}元/份</strong> 市场价： <del>￥：${singleProduct.market_price}元/份</del>
						</div>
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div align="center">
						<img src="${pageContext.request.contextPath}/${singleProduct.pimage}" height="300" width="270">
					</div>
					...
					<div style="background-color:#d3d3d3;width:900px;">
						<table class="table table-bordered">
							<tbody>
								<tr class="active">
									<th><strong>${singleProduct.pdesc}</strong></th>
								</tr>
								<tr class="warning">
